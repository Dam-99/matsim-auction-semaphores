...
public class SemaphoreServerProportionalPropagated extends SemaphoreServer implements ComunicationServer {
	...
	public SemaphoreServerProportionalPropagated(ComunicationFixedWrapper wrapper, ComunicationServerFactory.ServerData data) {
		super(wrapper, data);
