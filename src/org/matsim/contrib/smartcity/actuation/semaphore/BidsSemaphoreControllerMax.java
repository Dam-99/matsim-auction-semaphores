...
public class BidsSemaphoreControllerMax extends BidsSemaphoreController implements SignalController, ComunicationServer, CameraListener {

    public static final String IDENTIFIER = "SmartSemphoreControllerMax";
